...
for(i = 0; i < items.length; i++){
  ...
  <tr>
    ...
    <td>
      <button onclick=(populateOrder('${items[i].id}','${items[i].quantity}')) id="update-order" class="button-small button-primary"><i class="fas fa-pencil-alt"></i></button>
    </td>
  </tr>`;
